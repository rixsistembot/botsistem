...
def crack():
    ...
    try:
        ...
        try:
            file = open(idlist, 'r')
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar slur \x1b[1;97m...')
            for x in range(40):
